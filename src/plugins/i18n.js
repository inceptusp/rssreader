...
const messages = {
    pt: {
       ...
       "Welcome to RSS Reader, select a feed on the left to read":"Bem-vindo ao RSS Reader, selecione um feed à esquerda para ler",
       ...
       "Your email is not verified.":"Seu email não está verificado.",
       ...
       "Exit others sessions":"Sair de outras sessões",
       "Cancel":"Cancelar",
       "Save":"Salvar",
       "Confirm":"Confirmar",
       "Close":"Fechar",
